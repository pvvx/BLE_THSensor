...
#define ADV_BTHOME_UUID16 0xFCD2 // 16-bit UUID Service 0x181C HA_BLE, no security
...
//void bthome_encrypt_event_beacon(void); // n = RDS_TYPES

#endif // USE_SECURITY_BEACON

void bthome_data_beacon(void);
//void bthome_event_beacon(void); // n = RDS_TYPES
